...
//insert code for scene 5: option 1: person takes Linguini's hat off and the little chef turns around and sees Remy, option 2: person moves likttle chef to door, door "opens" and reveals pantry with rats, option 3: person moves littel chef to pantry door, physical door opens and reveals 3D pantry. 
.
